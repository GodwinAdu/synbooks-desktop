...
function createTables(db: SqlJsDatabase): void {
  ...
  db.run(`CREATE TABLE IF NOT EXISTS customers (id TEXT PRIMARY KEY, organizationId TEXT NOT NULL, customerNumber TEXT, name TEXT NOT NULL, email TEXT, phone TEXT, company TEXT, taxId TEXT, customerType TEXT DEFAULT 'individual', address TEXT DEFAULT '{}', creditLimit REAL DEFAULT 0, currentBalance REAL DEFAULT 0, paymentTerms TEXT DEFAULT 'net30', notes TEXT, status TEXT DEFAULT 'active', del_flag INTEGER DEFAULT 0, createdBy TEXT NOT NULL, modifiedBy TEXT, deletedBy TEXT, mod_flag INTEGER DEFAULT 0, createdAt TEXT DEFAULT (datetime('now')), updatedAt TEXT DEFAULT (datetime('now')), _syncVersion INTEGER DEFAULT 0, _lastSyncedAt TEXT, _dirty INTEGER DEFAULT 1)`);
  ...
  db.run(`CREATE TABLE IF NOT EXISTS expenses (id TEXT PRIMARY KEY, organizationId TEXT NOT NULL, expenseNumber TEXT NOT NULL, vendorId TEXT, categoryId TEXT, date TEXT NOT NULL, amount REAL DEFAULT 0, taxAmount REAL DEFAULT 0, taxRate REAL DEFAULT 0, isTaxable INTEGER DEFAULT 1, paymentMethod TEXT DEFAULT 'cash', reference TEXT, description TEXT, receiptUrl TEXT, status TEXT DEFAULT 'pending', isReimbursable INTEGER DEFAULT 0, expenseAccountId TEXT, paymentAccountId TEXT, projectId TEXT, approvedBy TEXT, approvedAt TEXT, rejectedBy TEXT, rejectedAt TEXT, rejectionReason TEXT, del_flag INTEGER DEFAULT 0, createdBy TEXT NOT NULL, modifiedBy TEXT, deletedBy TEXT, mod_flag INTEGER DEFAULT 0, createdAt TEXT DEFAULT (datetime('now')), updatedAt TEXT DEFAULT (datetime('now')), _syncVersion INTEGER DEFAULT 0, _lastSyncedAt TEXT, _dirty INTEGER DEFAULT 1)`);

  db.run(`CREATE TABLE IF NOT EXISTS bills (id TEXT PRIMARY KEY, organizationId TEXT NOT NULL, billNumber TEXT NOT NULL, vendorId TEXT, billDate TEXT NOT NULL, dueDate TEXT NOT NULL, lineItems TEXT DEFAULT '[]', subtotal REAL DEFAULT 0, taxAmount REAL DEFAULT 0, totalAmount REAL DEFAULT 0, paidAmount REAL DEFAULT 0, status TEXT DEFAULT 'draft', payableAccountId TEXT, expenseAccountId TEXT, projectId TEXT, notes TEXT, del_flag INTEGER DEFAULT 0, createdBy TEXT NOT NULL, modifiedBy TEXT, deletedBy TEXT, mod_flag INTEGER DEFAULT 0, createdAt TEXT DEFAULT (datetime('now')), updatedAt TEXT DEFAULT (datetime('now')), _syncVersion INTEGER DEFAULT 0, _lastSyncedAt TEXT, _dirty INTEGER DEFAULT 1)`);

  db.run(`CREATE TABLE IF NOT EXISTS products (id TEXT PRIMARY KEY, organizationId TEXT NOT NULL, sku TEXT NOT NULL, barcode TEXT, name TEXT NOT NULL, description TEXT, categoryId TEXT, categoryName TEXT, type TEXT DEFAULT 'product', costPrice REAL DEFAULT 0, sellingPrice REAL DEFAULT 0, margin REAL, taxable INTEGER DEFAULT 1, taxRate REAL, trackInventory INTEGER DEFAULT 1, currentStock REAL DEFAULT 0, reorderLevel REAL DEFAULT 20, reorderQuantity REAL, unit TEXT DEFAULT 'pcs', hasVariants INTEGER DEFAULT 0, variants TEXT DEFAULT '[]', bundleItems TEXT DEFAULT '[]', suppliers TEXT DEFAULT '[]', images TEXT DEFAULT '[]', primaryImage TEXT, priceTiers TEXT DEFAULT '[]', customFields TEXT DEFAULT '{}', status TEXT DEFAULT 'active', del_flag INTEGER DEFAULT 0, createdBy TEXT NOT NULL, modifiedBy TEXT, deletedBy TEXT, mod_flag INTEGER DEFAULT 0, createdAt TEXT DEFAULT (datetime('now')), updatedAt TEXT DEFAULT (datetime('now')), _syncVersion INTEGER DEFAULT 0, _lastSyncedAt TEXT, _dirty INTEGER DEFAULT 1)`);

  db.run(`CREATE TABLE IF NOT EXISTS employees (id TEXT PRIMARY KEY, organizationId TEXT NOT NULL, userId TEXT, name TEXT, employeeNumber TEXT, fullName TEXT, dateOfBirth TEXT, gender TEXT, email TEXT, phone TEXT, address TEXT DEFAULT '{}', department TEXT DEFAULT 'General', position TEXT DEFAULT 'Staff', employmentType TEXT DEFAULT 'full-time', hireDate TEXT, terminationDate TEXT, salary REAL DEFAULT 0, allowances TEXT DEFAULT '[]', paymentFrequency TEXT DEFAULT 'monthly', bankDetails TEXT DEFAULT '{}', taxInfo TEXT DEFAULT '{}', ssnitNumber TEXT, status TEXT DEFAULT 'active', del_flag INTEGER DEFAULT 0, createdBy TEXT NOT NULL, modifiedBy TEXT, deletedBy TEXT, mod_flag INTEGER DEFAULT 0, createdAt TEXT DEFAULT (datetime('now')), updatedAt TEXT DEFAULT (datetime('now')), _syncVersion INTEGER DEFAULT 0, _lastSyncedAt TEXT, _dirty INTEGER DEFAULT 1)`);
