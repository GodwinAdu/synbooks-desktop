/**
 * Sales Order Create Form - Full page form
 * Fields: Customer, Order Date, Expected Delivery, Line Items, Notes
...
export function SalesOrderCreateForm({ onBack }: Props) {
  const [submitting, setSubmitting] = useState<"save" | "confirm" | null>(null);
  ...
  const handleSubmit = async (action: "save" | "confirm") => {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Create an order for your customer</p>
        </div>
      </div>
      <Separator />
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input type="date" value={formData.orderDate} onChange={e => setFormData(prev => ({ ...prev, orderDate: e.target.value }))} />
                </div>
                <div className="space-y-2">
                  <Label>Expected Delivery Date</Label>
                  <Input type="date" value={formData.expectedDeliveryDate} onChange={e => setFormData(prev => ({ ...prev, expectedDeliveryDate: e.target.value }))} />
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  >
                    {submitting === "save" ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <Save className="h-4 w-4 mr-2" />}
                    Save Order
                  </Button>
                  <Button
                    className="w-full"
                  ...
                  >
                    {submitting === "confirm" ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <CheckCircle className="h-4 w-4 mr-2" />}
                    Confirm Order
                  </Button>
