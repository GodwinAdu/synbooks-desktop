/**
 * Recurring Invoice Create Form - Full page form
 * Fields: Template Name, Customer, Frequency, Start/End Date, Line Items
...
export function RecurringInvoiceCreateForm({ onBack }: Props) {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Set up automatic invoice generation</p>
        </div>
      </div>
      <Separator />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-6 space-y-4">
            <Card>
              <CardHeader><CardTitle>Template Summary</CardTitle></CardHeader>
              <CardContent className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Amount per Invoice</span>
