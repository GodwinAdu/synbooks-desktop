/**
 * Bill Create Form - Full page form with 2/3 + 1/3 sidebar layout
 * Fields: Bill Details, Line Items, Accounting, Notes + Summary sidebar
 */
...
export function BillCreateForm({ onBack }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.billDate) {
      toast.error("Please set a bill date");
      return;
    }
    if (!formData.dueDate) {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Record a vendor bill</p>
        </div>
      </div>
      <Separator />
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input value={formData.referenceNumber} onChange={e => updateField("referenceNumber", e.target.value)} placeholder="Vendor invoice #" />
                </div>
                <div className="space-y-2">
                  <Label>Bill Date *</Label>
                  <Input type="date" value={formData.billDate} onChange={e => updateField("billDate", e.target.value)} />
                </div>
                <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={e => updateField("payableAccountId", e.target.value)}
                    className="flex h-9 w-full rounded-md border border-input bg-background px-3 py-1 text-sm outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]"
                  >
